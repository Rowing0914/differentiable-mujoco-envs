...
#         initialise_simulation(d, time_initial, qpos_initial, qvel_initial, qacc_warmstart_initial, ctrl_initial,
#                               act_initial)
# 
#         # Perturb control
#         d.ctrl[i] += eps
...
#     reward = env.tensor_reward(torch.DoubleTensor(current_state), torch.DoubleTensor(ctrl),
#                                torch.DoubleTensor(next_state))
